...
document MUST abort the SCTP association if the dtls_sctp_ext extention
is received when DTLS/SCTP according to RFC 6083 is used. This mechanism
provides authenticated fallback to RFC 6083.
